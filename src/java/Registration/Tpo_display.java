 ...
 */
@WebServlet(name = "Tpo_display", urlPatterns = {"/Tpo_display"})
public class Tpo_display extends HttpServlet {
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
                ...
                //query
                    ...
                    PreparedStatement ps=con.prepareStatement("select * from tpo_register");
