 ...
 */
@WebServlet(name = "admission_table", urlPatterns = {"/admission_table"})
public class admission_table extends HttpServlet {
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
                ...
                //query
                    ...
                    PreparedStatement ps=con.prepareStatement("select * from newadmission");
