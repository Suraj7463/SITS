 ...
 */
@WebServlet(name = "pettycash_table", urlPatterns = {"/pettycash_table"})
public class pettycash_table extends HttpServlet {
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
                ...
                //query
                    ...
                    PreparedStatement ps=con.prepareStatement("select * from pettycash");
